...
export const AddButton: React.FC<AddButtonProps> = ({ text, loading, onClick, className, readonly }) => {
  return (
    <button
      type="button"
      onClick={() => {
    ...
    >
      {loading ? (
        <svg
          role="status"
          className="inline w-5 h-5 mr-2 text-transparent animate-spin fill-white"
          viewBox="0 0 100 101"
          fill="none"
