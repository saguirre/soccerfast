...
export const LandingMailingListSubscribe: React.FC = () => {
  ...
  return (
    <div className="mt-8 sm:max-w-lg sm:mx-auto sm:text-center lg:text-left lg:mx-0">
      ...
      <form action="#" method="POST" className="mt-3 flex flex-col items-center sm:flex sm:flex-row sm:items-center">
        <FormInputLarge id="email" type="email" name="email" placeholder={t('landing.mailingList.placeholder')} />
        <SubmitButton
          className="w-1/4 mt-3 sm:ml-2 py-3 rounded-lg sm:mt-0 flex items-center justify-center"
          text={t('landing.mailingList.submit')}
        />
      </form>
