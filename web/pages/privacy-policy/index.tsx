...
const PrivacyPolicy: NextPage = () => {
  return (
    <div className="h-full bg-white flex flex-col items-center justify-center pt-4 pb-20 sm:px-6 lg:px-8">
      <Title title="Política de Privacidad" subtitle="A continuación describimos nuestra Política de Privacidad. (Por el momento sólo se encuentra en inglés, dadas las restricciones de Miami, Florida)" />
      <div className="mt-8 max-w-7xl">
        <div className="bg-white py-6 px-4 text-slate-700 shadow-md border border-slate-100 sm:rounded-lg sm:px-10">
          <h1 className="text-slate-800 text-xl font-semibold">Privacy Policy</h1>
          <p className="text-slate-400 text-sm">Last updated: June 29, 2022</p>
          {/* Initial Description */}
          <div className="text-slate-600 text-sm mt-4">
            <p>
              This <b>Privacy Policy</b> describes Our policies and procedures on the collection, use and disclosure of
            ...
            <ul className="ml-4 mt-2 space-y-1.5">
              ...
              <li>
                <p>
                  ...
                  &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to SoccerFast LLC.
                </p>
              </li>
              <li>
                <p>
              ...
              <li>
                <p>
                  <strong>Website</strong> refers to SoccerFast, accessible from{" "}
                  <a href="http://www.soccerfastmiami.com" rel="external nofollow noopener" target="_blank">
                    http://www.soccerfastmiami.com
                  </a>
                </p>
              </li>
              <li>
          ...
          <h1 className="text-lg font-semibold mt-4 mb-2">Collecting and Using Your Personal Data</h1>
          <h2 className="text-regular font-semibold mb-2"> Types of Data Collected</h2>
          {/* Personal Data */}
          <div className="text-sm space-y-1.5">
            <h3 className="text-base font-medium mb-2">Personal Data</h3>
            <p>
          ...
          {/* Usage Data */}
          <div className="text-sm space-y-1.5">
            <h3 className="text-base font-medium my-2">Usage Data</h3>
          ...
          <div className="text-sm my-2">
            <h3 className="text-base font-medium my-2">Information from Third-Party Social Media Services</h3>
            <p>
          ...
          <div className="text-sm space-y-1.5 my-2">
            <h3 className="text-base font-semibold my-2">Tracking Technologies and Cookies</h3>
            <p>
          ...
          <div className="text-sm space-y-1.5 my-2">
            <h2 className="text-base font-semibold my-2">Use of Your Personal Data</h2>
          ...
          <div className="text-sm space-y-1.5 my-2">
            <h2 className="text-base font-semibold my-2">Retention of Your Personal Data</h2>
            <p>
          ...
          <div className="text-sm space-y-1.5 my-2">
            <h2 className="text-base font-semibold my-2">Disclosure of Your Personal Data</h2>
          ...
          <div className="text-sm space-y-1.5 my-2">
            <h2 className="text-base font-semibold my-2">Security of Your Personal Data</h2>
            <p>
          ...
          {/* Contact Us */}
          <div className="text-sm space-y-1.5 my-2">
            <h1 className="text-base font-semibold my-2">Contact Us</h1>
            <p>If you have any questions about this Privacy Policy, You can contact us:</p>
            <ul>
              <li>
                <p>By email: urucalv13@gmail.com</p>
              </li>
              <li>
                <p>
                  By visiting this page on our website:{" "}
                  <a href="http://www.soccerfastmiami.com/contact" rel="external nofollow noopener" target="_blank">
                    http://www.soccerfastmiami.com/contact
                  </a>
                </p>
              </li>
              <li>
                <p>By phone number: +1 (786) 306-8818</p>
              </li>
            </ul>
          </div>
        </div>
